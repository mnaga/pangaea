...
var SortSelectorView = Phoenix.View.extend({
  ...
  template: function() {
    ...
    var ret = Phoenix.View.prototype.template.apply(this, arguments);
    return ret && ret.trim();
  }
});
...
var ShelfDepartmentPicker = Phoenix.View.extend({
  ...
  disable: function(label) {
    this.setLabel(label || Phoenix.View.i18n('Search Results'));
  ...
  setLabel: function(label) {
    ...
    this.html('<span>' + (label || Phoenix.View.i18n('Departments')) + '</span>');
  },
  render: function() {
...
var ShelfDepartmentList = Phoenix.View.extend({
  ...
  events: {
    ...
    rendered: function() {
      var collection = (this.collection || {}).collection || {}; // represents the shelf collection
      if (_.isEmpty(collection.curDepartment)) {
...
helpers = helpers || Handlebars.helpers; data = data || {};
  ...
  buffer += "<div class=\"corrected-search-container\" style=\"display: none\">\n  Did you mean <a href=\"#\" class=\"search-suggestion\"></a>?\n</div>\n<div class=\"filters-applied\" style=\"display: none;\">\n  <div class=\"prev\"></div>\n  <div class=\"carousel\">\n    <span class=\"filters-label\">"
    + escapeExpression(helpers.i18n.call(depth0, "Filters", {hash:{},data:data}))
    + "</span>&nbsp;<span class=\"filters-value\"></span>\n  </div>\n  <div class=\"next\"></div>\n</div>\n"
...
function program3(depth0,data) {
  ...
  buffer += escapeExpression(((stack1 = helpers.link),stack1 ? stack1.call(depth0, depth0.itemPage, options) : helperMissing.call(depth0, "link", depth0.itemPage, options)))
    + "\"";
  return buffer;
  }
...
var FeaturedStories = Phoenix.View.extend({
...
helpers = helpers || Handlebars.helpers; data = data || {};
  ...
  buffer += escapeExpression(((stack1 = helpers.link),stack1 ? stack1.call(depth0, "shelf/{{shelfId}}", options) : helperMissing.call(depth0, "link", "shelf/{{shelfId}}", options)))
    + "\" data-position=\""
